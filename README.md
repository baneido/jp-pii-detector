...
| ゆうちょ銀行 記号番号 | `記号 1XX?0 / 番号 XXXXXX1` | ○ | ![F1 1.00](https://img.shields.io/badge/F1-1.00-brightgreen) | 記号4桁目の検査数字 + 番号との相関 + ゆうちょ固有の周辺語が必要 |
...
```toml
[tools]
"github:baneido/jp-pii-detector" = "v0.4.0"
```
