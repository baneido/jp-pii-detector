...
```sh
mise use -g github:baneido/jp-pii-detector@v0.3.6
```
...
```toml
[tools]
"github:baneido/jp-pii-detector" = "v0.3.6"
```
...
```sh
curl -fsSL https://raw.githubusercontent.com/baneido/jp-pii-detector/v0.3.6/scripts/install.sh | JP_PII_DETECT_VERSION=v0.3.6 sh
```
