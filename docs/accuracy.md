...
|---|--:|--:|--:|--:|:--:|
| `high` | 120 | 1 | 99.17% | 95.47% | PASS（≥97.5%） |
...
| Confidence | TP | FP | 実測適合率 | Wilson 95%下限 | 基準 |
|---|--:|--:|--:|--:|:--:|
| `high` | 151 | 1 | 99.34% | 96.37% | PASS（≥97.5%） |
...
| `jp-yucho-account` | 0.00 | 0.00 | 0.00 | 0 | 0 | 10 | 0 | 0 |
| **全体（マイクロ平均）** | **0.97** | **0.99** | **0.94** | 192 | 1 | 12 | 1 | 0 |
...
| `jp-yucho-account` | 0.00 | 0.00 | 0.00 | 0/0/10 | 0/0/10 | 0/0/10 |
| **全体（マイクロ平均）** | **0.97** | **0.97** | **0.97** | 193/0/12 | 193/0/12 | 193/0/12 |

マクロ平均F1: exact 0.94 / containment 0.94 / relaxed 0.94。
## プロファイル: medium
...
| `jp-bank-account` | 0.95 | 1.00 | 0.90 | 9 | 0 | 1 | 0 | 0 |
| `jp-yucho-account` | 0.00 | 0.00 | 0.00 | 0 | 0 | 10 | 0 | 0 |
| **全体（マイクロ平均）** | **0.97** | **0.99** | **0.95** | 252 | 2 | 12 | 2 | 0 |
...
| `jp-bank-account` | 0.95 | 0.95 | 0.95 | 9/0/1 | 9/0/1 | 9/0/1 |
| `jp-yucho-account` | 0.00 | 0.00 | 0.00 | 0/0/10 | 0/0/10 | 0/0/10 |
| **全体（マイクロ平均）** | **0.97** | **0.97** | **0.97** | 253/1/12 | 253/1/12 | 253/1/12 |

マクロ平均F1: exact 0.95 / containment 0.95 / relaxed 0.95。
...
- 総ケース数: 377
- 陽性ケース数: 263（うちスパン付与 263 件、付与率 100%）
- 陰性ケース数: 114
...
|---|:--:|:--:|:--:|--:|--:|--:|
| `line` | 0.97 | 0.99 | 0.94 | 190 | 1 | 12 |
| `content` | 1.00 | 1.00 | 1.00 | 1 | 0 | 0 |
| `diff` | 1.00 | 1.00 | 1.00 | 1 | 0 | 0 |
| **全体（マイクロ平均）** | **0.97** | **0.99** | **0.94** | 192 | 1 | 12 |
...
| `layout:line` | 0.96 | 1.00 | 0.93 | 133 | 0 | 10 |
| `polarity:negative` | 0.00 | 0.00 | 0.00 | 0 | 1 | 0 |
| `polarity:positive` | 0.96 | 1.00 | 0.93 | 135 | 0 | 10 |
...
| `rule:jp-yucho-account` | 0.00 | 0.00 | 0.00 | 0 | 0 | 10 |
