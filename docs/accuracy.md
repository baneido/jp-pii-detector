...
| `credit-card` | 0.80 | 0.67 | 1.00 | 10 | 5 | 0 | 5 | 0 |
| **全体（マイクロ平均）** | **0.96** | **0.93** | **0.99** | 192 | 14 | 2 | 14 | 0 |
...
| `jp-my-number` | 0.83 | 0.71 | 1.00 | 10 | 4 | 0 | 4 | 0 |
| `credit-card` | 0.80 | 0.67 | 1.00 | 10 | 5 | 0 | 5 | 0 |
| **全体（マイクロ平均）** | **0.96** | **0.94** | **0.99** | 232 | 15 | 2 | 15 | 0 |
...
|---|:--:|:--:|:--:|--:|--:|--:|
| `line` | 0.96 | 0.93 | 0.99 | 190 | 14 | 2 |
| `content` | 1.00 | 1.00 | 1.00 | 1 | 0 | 0 |
| `diff` | 1.00 | 1.00 | 1.00 | 1 | 0 | 0 |
| **全体（マイクロ平均）** | **0.96** | **0.93** | **0.99** | 192 | 14 | 2 |
...
| `layout:line` | 1.00 | 1.00 | 1.00 | 129 | 0 | 0 |
| `polarity:negative` | 0.00 | 0.00 | 0.00 | 0 | 14 | 0 |
| `polarity:positive` | 1.00 | 1.00 | 1.00 | 131 | 0 | 0 |
| `rule:credit-card` | 1.00 | 1.00 | 1.00 | 6 | 0 | 0 |
...
| `scenario:hard-negative-test-pan` | 0.00 | 0.00 | 0.00 | 0 | 5 | 0 |
| `source:curated-v2` | 1.00 | 1.00 | 1.00 | 131 | 0 | 0 |
| `source:hard-negative` | 0.00 | 0.00 | 0.00 | 0 | 14 | 0 |
| `source:legacy-curated` | 0.98 | 1.00 | 0.97 | 61 | 0 | 2 |
| **全体（マイクロ平均）** | **0.96** | **0.93** | **1.00** | 586 | 42 | 2 |
