...
func TestYuchoAccountRule(t *testing.T) {
	...
	tests := []struct {
		...
		{"再発行区分1桁を挟む表記", "ゆうちょ銀行 記号12390-2-1234561", []string{"jp-yucho-account"}},
		{"再発行区分1桁＋検査数字不一致", "ゆうちょ 12340-2-7654321", nil},
		{"再発行区分が2桁は対象外", "ゆうちょ 12390-25-1234561", nil},
		{"スペース区切りの記号番号", "ゆうちょ銀行 記号番号 12390 1234561", []string{"jp-yucho-account"}},
		{"スペース区切り＋検査数字不一致", "ゆうちょ 12340 7654321", nil},
		{"スペース区切り・コンテキストなし", "12390 1234561", nil},
		{"スペース区切り・金額の負コンテキストで抑制", "ゆうちょ 12390 1234561円", nil},
		{"JSON同一行のラベルペア", `{"記号": "12390", "番号": "1234561"}`, []string{"jp-yucho-account"}},
		{"読点区切りのラベルペア", "記号 12390、番号 1234561（ゆうちょ）", []string{"jp-yucho-account"}},
